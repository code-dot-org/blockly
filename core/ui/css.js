...
Blockly.Css.CONTENT = [
  ...
  '  stroke: #ccc;',
  '}',
  '.blocklyIconGroup:not(.readonly):hover>.blocklyIconShield {',
  '  fill: #00f;',
  '  stroke: #fff;',
  '  cursor: pointer;',
  '}',
  '.blocklyIconGroup:not(.readonly):hover>.blocklyIconMark {',
  '  fill: #fff;',
  '  cursor: pointer;',
  '}',
  '.blocklyIconGroup>.blocklyText {',
  '  font-size:9pt;',
  '  cursor: pointer;',
  '}',
  '.blocklyIconGroup.readonly>.blocklyText {',
  '  cursor: default;',
  '}',
  '.blocklyIconMark {',
  '  font-family: sans-serif;',
