...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'إنشاء لون باستخدام القيمة المحددة من اللون الأحمر والأخضر والأزرق.  يجب أن تكون كافة القيم بين 0 و 100.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = 'أنشئ';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'تحذير! هل أنت متأكد من أنك تريد حذف %1؟';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'المواصلة مع التكرار التالي من الحلقة';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'الخروج من الحلقة الحالية.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'تخطي ما تبقى من هذه الحلقة والمواصلة مع التكرار التالي.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'تحذير: يمكن استخدام هذا المربع البرمجي فقط داخل حلقة.';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "لكل عنصر في قائمة ما، عين المتغير '%1' إلى هذا العنصر، ومن ثم نفذ بعض الأوامر.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'اجعل المتغير %1 يأخذ القيم من رقم البداية إلى رقم النهاية وبالعد مستخدماً الفترات المحددة، وطبق أوامر المربعات البرمجية المحددة.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  'إضافة شرط إلى المربع البرمجي "إذا كان".';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'أضف شرط "نهاية، اجمع" إلى المربع البرمجي "إذا كان".';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'إضافة أو إزالة أو إعادة ترتيب المقاطع لإعادة تكوين المربع البرمجي "إذا كان".';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'إذا كانت قيمة ما تساوي "صحيح"، إذاً قم بتنفيذ بعض الأوامر.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'إذا كانت قيمة ما تساوي "صحيح"، إذاً قم بتنفيذ أول مربع برمجي من الأوامر. وإلا، قم بتنفيذ المربع البرمجي الثاني من الأوامر.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'إذا كانت القيمة الأولى تساوي "صحيح"، إذاً قم بتنفيذ المربع البرمجي الأول من الأوامر. وإلا، إذا كانت القيمة الثانية تساوي "صحيح"، قم بتنفيذ المربع البرمجي الثاني من الأوامر.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'إذا كانت القيمة الأولى تساوي "صحيح"، إذاً قم بتنفيذ المربع البرمجي الأول من الأوامر. وإلا، إذا كانت القيمة الثانية تساوي "صحيح"، قم بتنفيذ المربع البرمجي الثاني من الأوامر. إذا لم تكن هناك أي قيمة تساوي صحيح، قم بتنفيذ آخر مربع برمجي من الأوامر.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'ما دامت القيمة تساوي "خطأ"، قم بتنفيذ بعض الأوامر.';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'ما دامت القيمة تساوي "صحيح"، قم بتنفيذ بعض الأوامر.';
Blockly.Msg.DEFINE_HEADER_DEFINITION = 'تعريف';
Blockly.Msg.DEFINE_FUNCTION_DEFINE = 'عرّف';
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'قم بتعريف الدالة أدناه ثم حاول مرة أخرى.';
...
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "سيؤدي هذا إلى حذف كافة تواجدات العامل '%1'. هل أنت متأكد؟";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL =
  'ما الوظيفة المفترض أن تقوم بها الدالة الخاص بك؟';
Blockly.Msg.FUNCTION_PARAMETERS_LABEL =
  'ما العوامل التي تأخذها الدالة الخاص بك؟';
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'إرجاع قائمة، طولها 0، لا تحتوي على سجلات بيانات';
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  'إرجاع مؤشر التواجد الأول/الأخير في القائمة.  إرجاع 0 إذا لم يتم العثور على النص.';
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  'إنشاء قائمة تتألف من القيمة المعطاة متكررة لعدد محدد من المرات.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  'إدراج هذا العنصر في بداية قائمة.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END =
  'إدخال العنصر في الموضع المحدد في قائمة. #1 هو العنصر الأخير.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START =
  'إدخال العنصر في الموضع المحدد في قائمة. #1 هو العنصر الأول.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  'إضافة هذا العنصر إلى نهاية القائمة.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  'إدراج العنصر عشوائياً في القائمة.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'إرجاع صحيح إذا كان كلا المدخلات مساوية بعضها البعض.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'إرجاع صحيح إذا كان الإدخال الأول أكبر من الإدخال الثاني.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  'إرجاع صحيح إذا كان الإدخال الأول أكبر من أو يساوي الإدخال الثاني.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'إرجاع صحيح إذا كان الإدخال الأول أصغر من الإدخال الثاني.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'إرجاع صحيح إذا كان الإدخال الأول أصغر من أو يساوي الإدخال الثاني.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'إرجاع صحيح إذا كانت كلا المدخلات غير مساوية لبعضها البعض.';
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  'إرجاع صحيح إذا كان الإدخال خطأ. إرجاع خطأ إذا كان الإدخال صحيح.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'إرجاع صحيح إذا كان كلا المدخلات صحيح.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'إرجاع صحيح إذا كان واحد على الأقل من المدخلات صحيح.';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "التحقق من الشرط في 'الاختبار'. إذا كان الشرط صحيح، يقوم بإرجاع قيمة 'اذا صحيح'؛ خلاف ذلك يقوم بإرجاع قيمة 'اذا خطأ'.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  'إرجاع الرقم الأول مرفوع إلى أُس الرقم الثاني.';
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  'إرجاع أحد الثوابت الشائعة: π (3.141…) أو e (2.718…) أو φ (1.618…) أو sqrt(2) (1.414…) أو sqrt(½) (0.707…) أو ∞ (infinity).';
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  'تقييد العدد ليكون بين الحدود المحددة (ضمناً).';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'التحقق إذا كان العدد زوجياً، فردياً، أولياً، صحيحاً، موجباً، سالباً أو إذا كان قابلاً للقسمة على عدد معين.  إرجاع صحيح أو خطأ.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  'إرجاع المعدل (الوسط الحسابي) للقيم الرقمية في القائمة.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  'إرجاع قائمة من العنصر أو العناصر الأكثر شيوعاً في القائمة.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  'إرجاع مجموع كافة الأرقام الموجودة في القائمة.';
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  'إرجاع كسر عشوائي بين 0.0 (مشمول) و 1.0 (غير مشمول).';
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  'إرجاع عدد صحيح عشوائي بين حدين محددين، ضمنياً.';
...
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  'إرجاع tangent لدرجة (ليس زاوية نصف قطرية).';
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "تشغيل الدالة '%1' المعرفة من قِبل المستخدم.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "تشغيل الدالة '%1' المعرفة من قِبل المستخدم واستخدام مخرجاتها.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'إضافة أو إزالة أو إعادة ترتيب المقاطع لإعادة تكوين مربع النص البرمجي هذا.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  'الحصول على سلسلة فرعية من الحرف الأول';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  'الحصول على سلسلة فرعية من الحرف # من النهاية';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  'الحصول على سلسلة فرعية من الحرف #';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  'إرجاع مؤشر التواجد الأول/الأخير للنص الأول في النص الثاني. إرجاع 0 إذا لم يتم العثور على النص.';
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  'إرجاع عدد الأحرف (بما في ذلك الفراغات) في النص المقدم.';
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER =
  'الطلب من المستخدم لإدخال رقم ما مع إظهار رسالة';
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT =
  'الطلب من المستخدم لإدخال نص ما مع إظهار رسالة';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  'إرجاع نسخة من النص مع الفراغات المحذوفة من أحد أو كلا أطرافه.';
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  'تعيين هذا المتغير ليتساوى مع القيمة المدخلة.';
