goog.provide('Blockly.Msg.as_in');
goog.require('Blockly.Msg');
Blockly.Msg.ACTUAL = 'actual';
Blockly.Msg.ADD = 'Add';
Blockly.Msg.ADD_COMMENT = 'টোকা ভৰাওক';
Blockly.Msg.ADD_PARAMETER = 'Add Parameter';
Blockly.Msg.CHANGE_VALUE_TITLE = 'মান সলনি কৰক:';
Blockly.Msg.COLLAPSE_ALL = 'বিভাগবোৰ বন্ধ কৰক';
Blockly.Msg.COLLAPSE_BLOCK = 'বিভাগ বন্ধ কৰক';
...
Blockly.Msg.COLOUR_BLEND_TITLE = 'মিহলাওক';
...
Blockly.Msg.COLOUR_RGB_BLUE = 'নীলা';
Blockly.Msg.COLOUR_RGB_GREEN = 'সেউজীয়া';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'পৰবৰ্তীক চক্ৰটো চলাই যোৱা';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'ভিতৰৰ চক্ৰৰ পৰা বাহিৰ ওলাই আহক ৷';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'এই চক্ৰৰ বাকী অংশ বাদ দিয়ক, আৰু পৰবতৰ্ীক চক্ৰ চলাই যাওক ৷';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'সতৰ্কীকৰণ: এই খন্দটো কেৱল চক্ৰ এটাৰ ভিতৰত ব্যৱহাৰ কৰিব পাৰি ৷';
Blockly.Msg.CONTROLS_FOREACH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Loops#for_each';
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = 'তালিকা খনৰ';
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST_TAIL = '';
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = 'প্ৰতিটো পদৰ কাৰণে';
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  'তালিকা খনৰ প্ৰতিটো পদৰ কাৰণে - পদটো  %1 চলকটোৰে মূল্যাৰোপণ কৰক, আৰু  কাৰ্য্যকেইটা কৰক ৷';
Blockly.Msg.CONTROLS_FOR_HELPURL =
  'https://code.google.com/p/blockly/wiki/Loops#count_with';
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = '%1 ৰ পৰা %2 লৈকে %3 ৰ ব্যৱধানত';
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = 'গণনা কৰা';
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  '%1 চলকটোৰ মান প্ৰদত্ত ব্যৱধানত প্ৰথম সংখ্যাটোৰ পৰা শেষ সংখ্যাটোলৈ যাব, আৰু উল্লেখিত খন্দকেইটা সম্পাদন কৰিব ৷';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'if খন্দটোত এটা চৰ্ত যোগ কৰক ৷';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'if খন্দটোত সকলো সাঙুৰি লোৱা চৰ্ত এটা যোগ কৰা ৷';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'এই if খন্দটো সলনি কৰিবলৈ ভাগবোৰ যোগ কৰক, মচি পেলাওক, অথবা সালসলনি কৰক ৷';
Blockly.Msg.CONTROLS_IF_MSG_ELSE = 'অথবা';
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = 'অথবা যদি';
Blockly.Msg.CONTROLS_IF_MSG_IF = 'যদি';
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'যদি মান শুদ্ধ হয়, তেন্তে কাৰ্য্য কেইটা কৰক ৷';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "যদি মান শুদ্ধ হয়, তেন্তে  প্ৰথম খন্দৰ কাৰ্য্য কেইটা কৰক ৷ নহ'লে দ্বিতীয় খন্দৰ কাৰ্য্য কেইটা কৰক ৷ ";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "যদি প্ৰথম মান শুদ্ধ হয়, তেন্তে  প্ৰথম খন্দৰ কাৰ্য্য কেইটা কৰক ৷ নহ'লে, যদি দ্বিতীয় মান শুদ্ধ হয়, তেন্তে দ্বিতীয় খন্দৰ কাৰ্য্য কেইটা কৰক ৷";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "যদি প্ৰথম মান শুদ্ধ হয়, তেন্তে  প্ৰথম খন্দৰ কাৰ্য্য কেইটা কৰক ৷ নহ'লে, যদি দ্বিতীয় মান শুদ্ধ হয়, তেন্তে দ্বিতীয় খন্দৰ কাৰ্য্য কেইটা কৰক ৷ যদি কোনোটো মান শুদ্ধ নহয়, তেন্তে অন্তিম খন্দৰ কাৰ্য্য কেইটা কৰক ৷";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = 'http://en.wikipedia.org/wiki/For_loop';
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = 'কৰক';
Blockly.Msg.CONTROLS_REPEAT_TITLE = 'পুনৰায় %1বাৰ কৰক';
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = 'পুনৰায় কৰক';
Blockly.Msg.CONTROLS_REPEAT_TITLE_TIMES = 'বাৰ';
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = 'কাৰ্য্য কেইটা কেইবাবাৰো কৰক ৷';
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL =
  'http://code.google.com/p/blockly/wiki/Repeat';
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = 'যেতিয়ালৈকে নহয় পুনৰায় কৰক';
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = 'যেতিয়ালৈকে হয় পুনৰায় কৰক';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'যেতিয়ালৈকে মান অশুদ্ধ থাকে, কাৰ্য্য কেইটা কৰক ৷';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'যেতিয়ালৈকে মান শুদ্ধ থাকে, কাৰ্য্য কেইটা কৰক ৷.';
...
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "This will delete all '%1' parameter occurrences. Are you sure?";
Blockly.Msg.DELETE_X_BLOCKS = '%1 টা খন্দ মচি পেলাৱক';
Blockly.Msg.DISABLE_BLOCK = 'খন্দটো অক্ষম কৰক';
Blockly.Msg.DUPLICATE_BLOCK = 'দোহাৰক';
Blockly.Msg.ENABLE_BLOCK = 'খন্দটো সক্ষম কৰক';
Blockly.Msg.EXAMPLE = 'Example';
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Defines an example with expected and actual behavior';
Blockly.Msg.EXPAND_ALL = 'খন্দ কেইটা প্ৰসাৰণ কৰক';
Blockly.Msg.EXPAND_BLOCK = 'খন্দটো প্ৰসাৰণ কৰক';
Blockly.Msg.EXPECTED = 'expected';
Blockly.Msg.EXTERNAL_INPUTS = 'বাহ্যিক ইনপুট (input)';
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL =
  'What parameters does your function take?';
...
Blockly.Msg.HELP = 'সহায়';
Blockly.Msg.INLINE_INPUTS = 'ভিতৰুৱা ইনপুট্';
Blockly.Msg.LISTS_CREATE_EMPTY_HELPURL =
  'http://en.wikipedia.org/wiki/Linked_list#Empty_lists';
Blockly.Msg.LISTS_CREATE_EMPTY_TITLE = 'খালি তালিকা এখন বনোৱা ৷';
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'কোনো ডাটা (data) নথকা, শূণ্য দৈৰ্ঘ্যৰ এখন তালিকা বনাই ওভতাই দিয়ে ৷';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'তালিকা';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  'এই তালিকা খন্দটো সলনি কৰিবলৈ ভাগবোৰ যোগ কৰক, মচি পেলাওক, অথবা সালসলনি কৰক ৷.';
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = 'তালিকাখন বনোৱা';
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = 'তালিকাত এটা পদ যোগ কৰক ৷';
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  'যিকোনো সংখ্যক পদেৰে তালিকা এখন বনাওক ৷';
Blockly.Msg.LISTS_GET_INDEX_FIRST = 'প্ৰথম';
Blockly.Msg.LISTS_GET_INDEX_FROM_END = '# শেষৰ পৰা';
Blockly.Msg.LISTS_GET_INDEX_FROM_START = '#';
Blockly.Msg.LISTS_GET_INDEX_GET = 'বিচাৰি লোৱা';
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = 'বিচাৰি লোৱা আৰু গুচাই দিয়া';
Blockly.Msg.LISTS_GET_INDEX_LAST = 'অন্তিম';
Blockly.Msg.LISTS_GET_INDEX_RANDOM = 'যিকোনো';
Blockly.Msg.LISTS_GET_INDEX_REMOVE = 'গুচাই দিয়া';
Blockly.Msg.LISTS_GET_INDEX_TAIL = '';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  'তালিকাৰ প্ৰথম পদটো ঘূৰাই দিয়ে ৷';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END =
  'তালিকাৰ নিৰ্দিষ্ট অৱস্থানৰ পদটো ঘূৰাই দিয়া ৷ #1 অন্তিম পদ ৷';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START =
  'তালিকাৰ নিৰ্দিষ্ট অৱস্থানৰ পদটো ঘূৰাই দিয়া ৷ #1 অন্তিম পদ ৷.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  'তালিকাৰ অন্তিম পদটো ঘূৰাই দিয়ে ৷.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  'তালিকাৰ যিকোনো এটা পদ ঘূৰাই দিয়ে ৷.';
...
Blockly.Msg.LISTS_INLIST = 'তালিকা খনৰ';
