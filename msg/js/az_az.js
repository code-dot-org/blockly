...
Blockly.Msg.CANCEL = 'İmtina et';
Blockly.Msg.CHANGE_VALUE_TITLE = 'Qiyməti dəyiş:';
Blockly.Msg.CLOSE = 'Bağla';
...
Blockly.Msg.COLOUR_RANDOM_TITLE = 'ixtiyari rəng';
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = 'İxtiyari bir rəng seçin.';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'Göstərilən miqdarda qırmızı, yaşıl və göy komponenti olan bir rəng düzəlt. Bütün qiymətlər 0 və 100 arasında olmalıdır.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = 'Düzəlt';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'Xəbərdarlıq! %1 silinəcək. Bunu istədiyinizə əminsiniz?';
Blockly.Msg.CONFIRM_RENAME_VARIABLE = 'Adını dəyiş';
Blockly.Msg.CONTRACT_EDITOR_HEADER = 'Dizayn resepti';
...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY =
  '%1 ilə başlayıb, %2 qiymətinə kimi %3 qədər dəyiş';
...
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = 'et';
Blockly.Msg.CONTROLS_REPEAT_TITLE = '%1 dəfə təkrar';
...
Blockly.Msg.DEFINE_HEADER_DEFINITION = 'Tərif';
Blockly.Msg.DEFINE_FUNCTION_DEFINE = 'Təyin et';
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'Aşağıdakı funksiyanı təyin edərək bir daha cəhd edin.';
Blockly.Msg.DELETE = 'Sil';
Blockly.Msg.DELETE_BLOCK = 'Bloku sil';
Blockly.Msg.DELETE_PARAMETER = 'Parametri silin...';
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "Bu, hər yerdə '%1' parametrini pozacaq. Əminsiniz?";
Blockly.Msg.DELETE_X_BLOCKS = '%1 bloku sil';
Blockly.Msg.DISABLE_BLOCK = 'Bloku qeyri-aktiv et';
Blockly.Msg.DUPLICATE_BLOCK = 'Dublikatını düzəlt';
Blockly.Msg.ENABLE_BLOCK = 'Bloku aktivləşdir';
Blockly.Msg.EXAMPLE = 'Nümunə';
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Gözlənilən və faktiki davranışa malik bir nüminə təyin edir';
...
Blockly.Msg.FUNCTION_NAME_LABEL = 'Funksiyanıza ad verin:';
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL =
  'Funksiyanızın nə etməsi güman olunur?';
Blockly.Msg.FUNCTION_PARAMETERS_LABEL =
  'Funksiyanız hansı parametrləri qəbul edir?';
Blockly.Msg.FUNCTION_HEADER = 'Funksiya';
Blockly.Msg.FUNCTIONAL_CREATE = 'Yeni blok';
Blockly.Msg.FUNCTIONAL_EDIT = 'redaktə et';
Blockly.Msg.FUNCTIONAL_NAME_LABEL = 'Ad';
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = 'Tipini seçin...';
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = 'Təsvir';
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = 'Təyin oblastı';
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = 'Funksional metod təyin et';
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = 'Qiymətlər oblastı';
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = 'Bir dəyişən yarat';
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = 'Dəyişən';
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = 'Tip';
Blockly.Msg.HELP = 'Kömək';
Blockly.Msg.INLINE_INPUTS = 'Sətiriçi girişlər';
Blockly.Msg.KEEP = 'Saxla';
...
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = 'Siyahıya element əlavə et.';
...
Blockly.Msg.LISTS_LENGTH_TOOLTIP = 'Siyahının uzunluğunu qaytarır.';
...
Blockly.Msg.LISTS_SET_INDEX_SET = 'qoy';
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = '"Doğru" və ya "yalan" cavabını qaytarır.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Daxil olunan dəyərlər bir-birlərinə bərabər deyilsə, doğru cavabını ötür.';
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = 'bir şey etmək';
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = 'bu mətnin sonuna:';
...
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = 'bir şey etmək';
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = 'olsun';
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  'Əgər qiymət "doğru"-dursa onda ikinci dəyəri qaytar.';
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  'Xəbərdarlıq: Bu blok ancaq bir funksiyanın təyinatı daxilində istifadə oluna bilər.';
...
Blockly.Msg.RENAME_PARAMETER = 'Parametrin adını dəyiş...';
Blockly.Msg.RENAME_PARAMETER_TITLE =
  "Bütün '%1' parametrlərinin adını dəyişdir:";
Blockly.Msg.RENAME_THIS = 'Rename this %1';
Blockly.Msg.RENAME_VARIABLE = 'Dəyişənin adını dəyişdir...';
Blockly.Msg.RENAME_VARIABLE_TITLE =
  "Bütün '%1' dəyişənlərinin adını buna dəyişdir:";
...
Blockly.Msg.TEXT_CHARAT_FROM_END = 'axırdan # nömrəli hərfi götür';
Blockly.Msg.TEXT_CHARAT_FROM_START = '# nömrəli hərfi götür';
Blockly.Msg.TEXT_CHARAT_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Extracting_text';
Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT = 'mətndə';
Blockly.Msg.TEXT_CHARAT_LAST = 'axırıncı hərfi götür';
Blockly.Msg.TEXT_CHARAT_RANDOM = 'təsadüfi hərfi götür';
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = 'Qoşul';
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = 'axırdan # nömrəli hərfə qədər';
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = '# nömrəli hərfə qədər';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  'sondan # nömrəli hərfdən başlayaraq altsətri götür';
...
Blockly.Msg.TEXT_LENGTH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Text_modification';
Blockly.Msg.TEXT_LENGTH_TITLE = '%1 siyahısının uzunluğu';
...
Blockly.Msg.UNUSED_CODE = 'İşlənməmiş kod';
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = '"%1 götür"ü düzəlt';
Blockly.Msg.VARIABLES_SET_HELPURL = '';
Blockly.Msg.VARIABLES_SET_TAIL = 'olsun';
Blockly.Msg.VARIABLES_SET_TITLE = 'qoy';
