...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'Barreja dos colors amb la proporció donada (0.0 - 1.0).';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Per a cada element d'una llista, defineix la variable '%1' amb l'element, i després fes algunes ordres.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Fes que la variable %1 tingui els valors del nombre inicial fins al nombre final, comptant en l'interval especificat, i fes els blocs de dintre.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'Afegeix una condició al bloc "si".';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Afegeix una condició final, que ho capta tot, al bloc "si".';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Afegeix, suprimeix o reordena seccions per reconfigurar aquest bloc "si".';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Si un valor és cert, llavors fes un bloc d'ordres.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Si un valor és cert, llavors fes el primer bloc d'ordres. En cas contrari, fes el segon bloc d'ordres.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Si el primer valor és cert, llavors fes el primer bloc d'ordres. En cas contrari, si el segon valor és cert, fes el segon bloc d'ordres.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Si el primer valor és cert, fes el primer bloc d'ordres. En cas contrari, si el segon valor és cert, fes el segon bloc d'ordres. Si cap dels valor són certs, fes l'últim bloc d'ordres.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL =
  'http://code.google.com/p/bloc/wiki/Repeat';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Fes un bloc d'ordres mentre un valor sigui fals.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Fes un bloc d'ordres mentre un valor sigui cert.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'Defineix la funció de sota i torna a intentar-ho.';
...
Blockly.Msg.DELETE_PARAMETER_TITLE =
  'Això suprimirà totes les ocurrències de paràmetre de "%1". Esteu segur?';
...
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Defineix un exemple amb el comportament pevist i el real';
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'Retorna una llista, de longitud 0, que no conté cap registre de dades';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'llista';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  'Afegeix, suprimeix o reordena seccions per reconfigurar aquest bloc de llista.';
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Crea una llista amb qualsevol nombre d'elements.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END =
  "Retorna l'element en la posició especificada d'una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START =
  "Retorna l'element en la posició especificada d'una llista. #1 és el primer element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Retorna l'últim element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Retorna un element aleatori d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Elimina i retorna el primer element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END =
  "Elimina i retorna l'element en la posició especificada d'una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START =
  "Elimina i retorna l'element en la posició especificada d'una llista. #1 és el primer element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Elimina i retorna l'últim element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Elimina i retorna un element aleatori d'una llista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END =
  "Elimina l'element en la posició especificada d'una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START =
  "Elimina l'element en la posició especificada d'una llista. #1 és el primer element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Elimina l'últim element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Elimina un element aleatori d'una llista.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Retorna l'índex de la primera/última aparició de l'element en la llista. Retorna 0 si el text no hi apareix.";
...
Blockly.Msg.LISTS_LENGTH_TOOLTIP =
  "Retorna la quantitat d'elements d'una llista.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "crea una llista amb l'element %1 repetit %2 vegades";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  'Crea una llista que conté un valor repetit un nombre determinat de vegades.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Insereix l'element al principi d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END =
  "Insereix l'element en la posició especificada d'una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START =
  "Insereix l'element en la posició especificada d'una llista. #1 és el primer element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Afegeix l'element al final d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Insereix l'element a l'atzar en una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Estableix el primer element d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END =
  "Estableix l'element en la posició especificada d'una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START =
  "Estableix l'element en la posició especificada d'una llista. #1 és el primer element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Estableix l'últim element d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Estableix un element a l'atzar en una llista.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Retorna cert si les dues dades d'entrada són iguals.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Retorna cert si la primera dada d'entrada és més gran que la segona dada d'entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Retorna cert si la primera dada d'entrada és més gran o igual que la segona dada d'entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Retorna cert si la primera dada d'entrada és més petita que la segona dada d'entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Retorna cert si la primera dada d'entrada és més petita o igual que la segona dada d'entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Retorna cert si les dues dades d'entrada no són iguals entre si.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Retorna cert si l'entrada és falsa. Retorna fals si l'entrada és certa.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Retorna cert si les dues entrades són certes.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Retorna cert si almenys una de les entrades és certa.';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Comprova la condició en 'test'. Si la condició és certa, retorna el valor de 'si és cert'; en cas contrari, retorna el valor de 'si és fals'.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  'Retorna el primer nombre elevat al segon nombre.';
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  'Retorna una de les constants més comuns: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (infinit).';
Blockly.Msg.MATH_CONSTRAIN_HELPURL =
  'http://en.wikipedia.org/wiki/Clamping_%28graphics%29';
Blockly.Msg.MATH_CONSTRAIN_TITLE =
  'restringeix %1 a com a mínim %2 i com a màxim %3';
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  'Restringeix un número perquè estigui entre dos límits especificats (inclosos).';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Comprova si un número és parell, imparell, prim, enter, positiu, negatiu o si és divisible per un cert número. Retorna verdader o fals.';
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  'Retorna el residu de dividir entre dos números.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Retorna la mitjana (mitjana aritmètica) dels valors numèrics d'una llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Retorna el número més gran d'una llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  "Retorna la mediana dels números d'una llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Retorna el número més petit d'una llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  'Retorna una llista amb el(s) element(s) que més es repeteixen en una llista.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  'Retorna un element aleatori de la llista.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Retorna la desviació estàndard d'una llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Retorna la suma de tots els números d'una llista.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  'Retorna una fracció aleatòria entre 0.0 (inclós) i 1.0 (exclós).';
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  'Retorna un número aleatori entre dos límits especificats, inclosos.';
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Retorna el logaritme natural d'un nombre.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Retorna el cosinus d'un angle en graus (no radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Retorna el sinus d'un angle en graus (no radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Retorna la tangent d'un angle en graus (no radians).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Executar la funció '%1' definida per l'usuari.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Executa la funció '%1' definida per l'usuari i utilitza el resultat.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  'Crea una funció sense dades de sortida.';
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  'Avís: Aquesta funció té paràmetres duplicats.';
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = 'Destacar definició de funció';
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  'Si un valor és cert, retorna un segon valor.';
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  'Avís: Aquest bloc només es pot utilitzar dins una definició de funció.';
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  'Retorna una còpia del text amb les majúscules i minúscules canviades.';
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  'Retorna la lletra a la posició especificada.';
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'Afegeix, suprimeix, o reordena seccions per reconfigurar aquest bloc de text.';
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END =
  'fins a la lletra # començant pel final';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Retorna l'índex de la primera/última aparició del primer text en el segon text. Retorna 0 si text no hi apareix.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Crea un tros de text combinant qualsevol nombre d'elements.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Text_modification';
Blockly.Msg.TEXT_LENGTH_TITLE = 'longitud de %1';
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  'Retorna el nombre de lletres (inclosos els espais en blanc) que hi ha al text especificat.';
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH =
  'elimina els espais al principi i al final';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Retorna una còpia del text on els espais en blanc s'han eliminat en un o els dos extrems.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Estableix aquesta variable igual a la dada d'entrada.";
