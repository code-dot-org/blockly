...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'Salta el resto de estas iteraciones, y continua con la siguiente.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'Si un valor es verdadero, entonces haz algunas declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'Si un valor es verdadero, entonces haz el primer bloque de declaraciones.  De lo contrario, haz el segundo bloque de declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'Si el primer valor es verdadero, entonces haz el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, haz el segundo bloque de declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'Si el primer valor es verdadero, entonces haz el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, haz el segundo bloque de declaraciones. Si ninguno de los valores son verdaderos, haz el último bloque de declaraciones.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'Mientras que un valor sea verdadero, entonces haz algunas declaraciones.';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Comprueba si un número es par, impar, primo, entero, positivo, negativo, o si este es divisible por un número determinado. Devuelve verdadero o falso.';
