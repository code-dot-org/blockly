...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  '¡Advertencia! ¿Estás seguro que deseas eliminar %1?';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Para cada elemento en una lista, establece la variable '%1' en el elemento y luego hacer algunas declaraciones.";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  'Agrega una condición al bloque condicional IF.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'Si un valor es verdadero, entonces realiza algunas declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'Si un valor es verdadero, entonces haz el primer bloque de declaraciones. De lo contrario, realiza el segundo bloque de declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'Si el primer valor es verdadero, entonces realiza el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, realiza el segundo bloque de declaraciones.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'Si el primer valor es verdadero, entonces realiza el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, realiza el segundo bloque de declaraciones. Si ninguno de los valores es verdadero, realiza el último bloque de declaraciones.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'Mientras que un valor sea falso, entonces haz algunas declaraciones.';
...
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "Esto borrará todas las ocurrencias de parámetro '%1'. ¿Estás seguro?";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'Devuelve una lista, de longitud de 0, que no contenga ningún registro de datos';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'lista';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  'Agregar, eliminar o reorganizar las secciones para reconfigurar esta lista de bloques.';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END =
  'Devuelve el elemento a la posición especificada en la lista. #1 es el último elemento.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START =
  'Devuelve el elemento a la posición especificada en la lista. #1 es el primer elemento.';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END =
  'Elimina y devuelve el elemento a la posición especificada en la lista. #1 es el último elemento.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START =
  'Elimina y devuelve el elemento a la posición especificada en la lista. #1 es el primer elemento.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END =
  'Inserta el elemento a la posición especificada en una lista. #1 es el último elemento.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START =
  'Inserta el elemento en la posición especificada en una lista.   #1 es el primer elemento.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  'Inserta aleatoriamente el elemento en una lista.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  'Establece el primer elemento en una lista.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END =
  'Establece el elemento a la posición especificada en una lista. #1 es el último elemento.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Devolver verdadero si ambas entradas son iguales entre si.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Devolver verdadero si la primera entrada es mayor que la segunda entrada.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'Devuelve verdadero si la primera entrada es menor o igual a la segunda entrada.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Devuelve verdadero si ambas entradas no son iguales entre sí.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Devolver verdadero si al menos una de las entradas es verdadera.';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  'Comprobar la condición en "probar". Si la condición es verdadera, devolver el valor "si es cierto"; de lo contrario, devolver el valor "si es falso".';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  'Devolver el número más grande en la lista.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  'Devolver una lista de los elementos más comunes en la lista.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  'Devolver un elemento aleatorio de la lista.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  'Devolver la desviación estándar de la lista.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  'Devolver la suma de todos los números en la lista.';
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  'Devolver un entero aleatorio entre los dos límites especificados, inclusivos.';
...
Blockly.Msg.RENAME_PARAMETER_TITLE =
  "Cambiar nombre de todos los parámetros '%1' a:";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  'Cambiar el nombre de todas las variables «%1» a:';
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE =
  'convierte la primera letra de cada palabra a mayúscula y el resto de la palabra a minúsculas';
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  'Devuelve la letra a la posición especificada.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  'obtener subcadena desde la letra #';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  'Devuelve el índice de la primera/última aparición del primer texto en el segundo texto. Devuelve 0 si no se encuentra el texto.';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  'Devuelve una copia del texto con los espacios eliminados de uno o ambos extremos.';
