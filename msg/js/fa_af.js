...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'ادامه به تکرار بعدی حلقه ی تکرار';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'از حلقه ی تکرار فعلی خارج شو.';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'اخطار: این بلاک فقط ميتواند در داخل یک حلقه استفاده شود.';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  'برای هر مورد در این لیست، قیمت متغیر را به مورد «%1» بده، و بعد چند دستور انجام بده.';
