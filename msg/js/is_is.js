...
Blockly.Msg.ADD = 'Bæta við';
Blockly.Msg.ADD_COMMENT = 'Skrifa skýringu';
Blockly.Msg.ADD_PARAMETER = 'Bæta við stika';
Blockly.Msg.CANCEL = 'Hætta við';
Blockly.Msg.CHANGE_VALUE_TITLE = 'Breyta gildi:';
Blockly.Msg.CLOSE = 'Loka';
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'Blandar saman tveimur litum í gefnu hlutfalli (0,0 - 1,0).';
Blockly.Msg.COLOUR_PICKER_HELPURL = 'http://en.wikipedia.org/wiki/Color';
Blockly.Msg.COLOUR_PICKER_TOOLTIP = 'Velja lit af litaspjaldinu.';
...
Blockly.Msg.COLOUR_RGB_BLUE = 'blár';
Blockly.Msg.COLOUR_RGB_GREEN = 'grænn';
Blockly.Msg.COLOUR_RGB_HELPURL = '';
Blockly.Msg.COLOUR_RGB_RED = 'rauður';
Blockly.Msg.COLOUR_RGB_TITLE = 'litur með';
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'Búa til lit með hinu tiltekna magni af rauðu, grænu og bláu. Öll gildin þurfa að vera á bilinu 0 til 100.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = 'Búa til';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'Aðvörun! Ertu viss um að þú viljir eyða %1?';
Blockly.Msg.CONFIRM_RENAME_VARIABLE = 'Endurnefna';
Blockly.Msg.CONTRACT_EDITOR_HEADER = 'Hönnunaruppskrift';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'fara beint í næstu umferð lykkjunnar';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'Fara út úr umlykjandi lykkju.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'Sleppa restinni af þessari lykkju og halda áfram með næstu ítrun.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'Aðvörun: Þennan kubb má aðeins nota innan lykkju.';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Fyrir hvert atriði í lista er breyta '%1' stillt á atriðið og skipanir gerðar.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Bæta við, fjarlægja eða umraða til að breyta skipan þessa EF kubbs.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'Ef gildi er satt skal gera einhverjar skipanir.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'Endurtaka eitthvað á meðan gildi er ósatt.';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'Endurtaka eitthvað á meðan gildi er satt.';
Blockly.Msg.DEFINE_HEADER_DEFINITION = 'Skilgreining';
Blockly.Msg.DEFINE_FUNCTION_DEFINE = 'Skilgreina';
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'Skilgreindu fallið hér fyrir neðan og reyndu aftur.';
Blockly.Msg.DELETE = 'Eyða';
Blockly.Msg.DELETE_BLOCK = 'Eyða kubb';
Blockly.Msg.DELETE_PARAMETER = 'Eyða stika...';
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "Þetta mun eyða öllum tilfellum af stikanum '%1'. Ertu viss?";
...
Blockly.Msg.EXAMPLE = 'Dæmi';
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Skilgreinir dæmi með væntanlegri og raunverulegri virkni';
Blockly.Msg.EXPAND_ALL = 'Opna kubba';
Blockly.Msg.EXPAND_BLOCK = 'Opna kubb';
Blockly.Msg.EXPECTED = 'útkoma';
Blockly.Msg.EXTERNAL_INPUTS = 'Ytri inntök';
Blockly.Msg.FUNCTION_CREATE = 'Búa til fall';
Blockly.Msg.FUNCTION_EDIT = 'breyta';
Blockly.Msg.FUNCTION_NAME_LABEL = 'Gefa fallinu heiti:';
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = 'Hvað á fallið þitt að gera?';
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = 'Hvaða stika tekur fallið þitt?';
Blockly.Msg.FUNCTION_HEADER = 'Aðgerð';
Blockly.Msg.FUNCTIONAL_CREATE = 'Nýr kubbur';
Blockly.Msg.FUNCTIONAL_EDIT = 'breyta';
Blockly.Msg.FUNCTIONAL_NAME_LABEL = 'Nafn';
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = 'Velja gerð...';
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = 'Lýsing';
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = 'Gildamengi';
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = 'Skilgreina aðferð með falli';
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = 'Svið';
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = 'Búa til breytu';
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = 'Breyta';
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = 'Tegund';
Blockly.Msg.HELP = 'Hjálp';
Blockly.Msg.INLINE_INPUTS = 'Innri inntök';
Blockly.Msg.KEEP = 'Geyma';
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  'Búa til lista með einhverjum fjölda atriða.';
...
Blockly.Msg.LISTS_GET_INDEX_RANDOM = 'eitthvað';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  'Skilar einhverju atriði úr lista.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  'Fjarlægir og skilar fyrsta atriðinu í lista.';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  'Fjarlægir og skilar síðasta atriðinu í lista.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  'Fjarlægir og skilar einhverju atriði úr lista.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  'Fjarlægir fyrsta atriðið í lista.';
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  'Fjarlægir síðasta atriðið í lista.';
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  'Fjarlægir eitthvert atriði úr lista.';
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = 'sækja listabút frá fyrsta';
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  'sækja listabút frá\\u00A0# frá enda';
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = 'sækja listabút frá #';
Blockly.Msg.LISTS_GET_SUBLIST_TAIL = '';
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  'Býr til afrit af tilteknum hluta lista.';
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  'Finnur hvar atriðið kemur fyrir fyrst/síðast í listanum og skilar sæti þess. Skilar 0 ef atriðið finnst ekki.';
...
Blockly.Msg.LISTS_LENGTH_INPUT_LENGTH = 'lengd';
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  'búa til lista með atriði %1 endurtekið %2 sinnum';
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  'Býr til lista sem inniheldur tiltekna gildið endurtekið tiltekið oft.';
...
Blockly.Msg.LISTS_SET_INDEX_INSERT = 'setja í';
Blockly.Msg.LISTS_SET_INDEX_SET = 'setja';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  'Bætir atriðinu fremst í listann.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  'Bætir atriðinu aftan við listann.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  'Bætir atriðinu einhversstaðar við listann.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  'Setur atriðið í fyrsta sæti lista.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END =
  'Setur atriðið í tiltekna sætið í listanum. #1 er síðasta atriðið.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  'Setur atriðið í síðasta sæti lista.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  'Setur atriðið í eitthvert sæti lista.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Skila sönnu ef fyrra inntakið er stærra en seinna inntakið.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  'Skila sönnu ef fyrra inntakið er stærra en eða jafnt og seinna inntakið.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'Skila sönnu ef fyrra inntakið er minna en seinna inntakið.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'Skila sönnu ef fyrra inntakið er minna en eða jafnt og seinna inntakið.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Skila sönnu ef inntökin eru ekki jöfn.';
Blockly.Msg.LOGIC_NEGATE_HELPURL = '';
Blockly.Msg.LOGIC_NEGATE_TITLE = 'ekki %1';
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  'Skilar sönnu ef inntakið er ósatt. Skilar ósönnu ef inntakið er satt.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Skila sönnu ef bæði inntökin eru sönn.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Skila sönnu ef að minnsta kosti eitt inntak er satt.';
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  'Skila fyrri tölunni í veldinu seinni talan.';
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  'Þröngva tölu til að vera innan hinna tilgreindu marka (að báðum meðtöldum).';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Athuga hvort tala er jöfn, oddatala, prímtala, heil, jákvæð, neikvæð eða hvort hægt er að deila henni með ákveðinni tölu. Skilar sönnu eða ósönnu.';
Blockly.Msg.MATH_IS_WHOLE = 'er heil';
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MAX = 'hámark lista';
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = 'miðgildi lista';
Blockly.Msg.MATH_ONLIST_OPERATOR_MIN = 'lágmark lista';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  'Skila lista yfir tíðustu gildin í listanum.';
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG =
  'Skila neitun tölu (tölunni með öfugu formerki).';
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Keyra heimatilbúna fallið '%1' og nota úttak þess.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = 'gera eitthvað';
...
Blockly.Msg.RENAME_PARAMETER = 'Endurnefna stika...';
Blockly.Msg.RENAME_PARAMETER_TITLE = "Endurnefna alla '%1' stikana:";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  'Skila afriti af textanum með annarri stafastöðu.';
...
Blockly.Msg.TEXT_CHARAT_HELPURL =
  'https://code.google.com/p/blockly/wiki/Texti#Draga_texta_út';
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = 'Vera með';
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'Bæta við, fjarlægja eða umraða hlutum til að breyta skipan þessa textakubbs.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  'sækja textabút frá staf # frá enda';
...
Blockly.Msg.TEXT_INDEXOF_HELPURL =
  'https://code.google.com/p/blockly/wiki/Texti#Ad_finna_texta';
Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT = 'í texta';
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = 'finna fyrsta tilvik texta';
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = 'finna síðasta tilvik texta';
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  'Búa til texta með því að tengja saman einhvern fjölda atriða.';
Blockly.Msg.TEXT_LENGTH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Text_modification';
Blockly.Msg.TEXT_LENGTH_TITLE = 'lengd %1';
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  'Skilar fjölda stafa (með bilum) í gefna textanum.';
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  'Prenta tiltekinn texta, tölu eða annað gildi.';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  'Skila afriti af textanum þar sem möguleg bil við báða enda hafa verið fjarlægð.';
Blockly.Msg.UNUSED_CODE = 'Ónotaður kóði';
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  'Stillir þessa breytu á innihald inntaksins.';
