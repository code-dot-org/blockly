...
Blockly.Msg.CANCEL = '취소';
Blockly.Msg.CHANGE_VALUE_TITLE = '값 변경:';
Blockly.Msg.CLOSE = '닫기';
Blockly.Msg.COLLAPSE_ALL = '블록 축소';
Blockly.Msg.COLLAPSE_BLOCK = '블록 축소';
Blockly.Msg.COLOUR_BLEND_COLOUR1 = '색1';
Blockly.Msg.COLOUR_BLEND_COLOUR2 = '색2';
Blockly.Msg.COLOUR_BLEND_HELPURL =
  'http://meyerweb.com/eric/tools/color-blend/';
Blockly.Msg.COLOUR_BLEND_RATIO = '혼합 비율';
Blockly.Msg.COLOUR_BLEND_TITLE = '섞기';
Blockly.Msg.COLOUR_BLEND_TOOLTIP = '두 색을 주어진 비율(0.0 - 1.0)로 섞습니다.';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  '지정한 빨강, 녹색, 파랑 색의 양으로 색을 만들어냅니다. 빨강/녹색/파랑색의 양은 0 - 100 이어야 합니다.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = '만들기';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  '경고! 정말로 %1을 삭제하시겠습니까?';
Blockly.Msg.CONFIRM_RENAME_VARIABLE = '이름 바꾸기';
Blockly.Msg.CONTRACT_EDITOR_HEADER = '디자인 레시피';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "리스트 안에 들어있는 각 아이템들을, 순서대로 변수 '%1' 에 한 번씩 저장시키고, 그 때 마다 명령을 실행합니다.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  '변수 %1 의 값을 변경하면서 반복 실행합니다. 변수에 저장되는 값은, 첫번째 수부터 두번째 수까지, 일정 값씩 늘어납니다.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = '"만약" 블록에 조건을 추가합니다.';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  '"만약" 블럭의 마지막에, 모든 검사 결과가 거짓인 경우 실행할 부분을 추가합니다.';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  '"만약" 블럭의 내용을 추가, 삭제, 재구성 합니다.';
Blockly.Msg.CONTROLS_IF_MSG_ELSE = 'else';
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = '그렇지 않으면';
Blockly.Msg.CONTROLS_IF_MSG_IF = '만약';
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  '조건식의 계산 결과가 참이면, 명령을 실행합니다.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  '조건식의 계산 결과가 참이면, 첫번째 블럭의 명령을 실행하고, 그렇지 않으면 두번째 블럭의 명령을 실행합니다.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  '첫번째 조건식의 계산 결과가 참이면, 첫번째 블럭의 명령을 실행하고, 두번째 조건식의 계산 결과가 참이면, 두번째 블럭의 명령을 실행합니다.';
...
Blockly.Msg.CONTROLS_REPEAT_TITLE_TIMES = '번';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  '조건이 거짓인 동안, 반복적으로 명령들을 실행합니다.';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  '조건이 참인 동안, 반복적으로 명령들을 실행합니다.';
Blockly.Msg.DEFINE_HEADER_DEFINITION = '정의';
Blockly.Msg.DEFINE_FUNCTION_DEFINE = '함수 정의';
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  '아래 함수를 정의하시고 다시 시도해 주세요.';
Blockly.Msg.DELETE = '삭제';
Blockly.Msg.DELETE_BLOCK = '블록 삭제';
Blockly.Msg.DELETE_PARAMETER = '매개 변수 삭제...';
Blockly.Msg.DELETE_PARAMETER_TITLE = "모든 '%1' 매개 변수를 삭제할까요?";
Blockly.Msg.DELETE_X_BLOCKS = "블럭 '%1' 개 삭제";
Blockly.Msg.DISABLE_BLOCK = '실행 되지 않도록 설정';
Blockly.Msg.DUPLICATE_BLOCK = '복사';
Blockly.Msg.ENABLE_BLOCK = '실행 되도록 설정';
Blockly.Msg.EXAMPLE = '예시';
Blockly.Msg.EXAMPLE_DESCRIPTION = '예상되는 예시와 실제 동작을 정의합니다.';
Blockly.Msg.EXPAND_ALL = '블럭들 펼치기';
Blockly.Msg.EXPAND_BLOCK = '블럭 펼치기';
Blockly.Msg.EXPECTED = '결과';
Blockly.Msg.EXTERNAL_INPUTS = '내부에서 값 입력';
Blockly.Msg.FUNCTION_CREATE = '함수 만들기';
Blockly.Msg.FUNCTION_EDIT = '수정하기';
Blockly.Msg.FUNCTION_NAME_LABEL = '함수 이름:';
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = '함수의 기능?';
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = '함수가 사용하는 매개 변수?';
Blockly.Msg.FUNCTION_HEADER = '함수';
Blockly.Msg.FUNCTIONAL_CREATE = '새 블록';
Blockly.Msg.FUNCTIONAL_EDIT = '수정하기';
Blockly.Msg.FUNCTIONAL_NAME_LABEL = '이름';
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = '종류 선택...';
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = '설명';
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = '도메인';
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = '함수적 매서드 정의';
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = '범위';
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = '변수 만들기';
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = '변수';
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = '유형';
Blockly.Msg.HELP = '도움말';
Blockly.Msg.INLINE_INPUTS = '외부에서 값 입력';
Blockly.Msg.KEEP = '계속';
...
Blockly.Msg.LISTS_GET_INDEX_RANDOM = 'random(랜덤)';
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  '원하는 값을, 원하는 갯수 만큼 넣어, 새로운 리스트를 생성합니다.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  '두 값이 같으면, 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  '첫 번째 값이 두 번째 값보다 크면, 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  '첫 번째 값이 두 번째 값보다 크거나 같으면, 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  '첫 번째 값이 두 번째 값보다 작으면, 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  '첫 번째 값이 두 번째 값보다 작거나 같으면, 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  '두 값이 서로 다르면, 참(true) 값을 돌려줍니다.';
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  '입력값이 참(true) 값이면 거짓(false) 값을 돌려주고, 거짓(false) 값이면 참(true) 값을 돌려줍니다.';
Blockly.Msg.LOGIC_NULL = '값 없음';
Blockly.Msg.LOGIC_NULL_HELPURL = 'http://en.wikipedia.org/wiki/Nullable_type';
Blockly.Msg.LOGIC_NULL_TOOLTIP = '값 없음(null)을 돌려줍니다.';
Blockly.Msg.LOGIC_OPERATION_AND = '이면서';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  '어떤 수가 짝수, 홀수, 소수, 정수, 양수, 음수, 나누어 떨어지는 수 인지 검사해 결과값을 돌려줍니다. 참(true) 또는 거짓(false) 값을 돌려줌.';
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  '첫 번째 수를 두 번째 수로 나눈 나머지 값을 돌려줍니다.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  '리스트에 들어있는 수(값)들에 대해, 산술 평균(arithmetic mean) 한 값을 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  '리스트에 들어있는 수(값) 들 중, 가장 큰(max) 수(값)를 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  '리스트에 들어있는 수(값) 들 중, 중간(median) 수(값)를 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  '리스트에 들어있는 수(값) 들 중, 가장 작은(min) 수(값)를 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  '리스트에 들어있는 아이템들 중에서, 가장 여러 번 들어있는 아이템들을 리스트로 만들어 돌려줍니다. (최빈값, modes)';
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  '리스트에 들어있는 아이템들 중에서, 랜덤(random)으로 아이템을 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  '리스트에 들어있는 수(값)들에 대해, 표준 편차(standard deviation) 를 구해 돌려줍니다.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  '리스트에 들어있는 수(값)들을, 모두 합(sum) 한, 총합(sum)을 돌려줍니다.';
...
Blockly.Msg.MATH_TRIG_TOOLTIP_ACOS =
  '어떤 수에 대한 acos(arccosine) 값을 돌려줍니다.';
Blockly.Msg.MATH_TRIG_TOOLTIP_ASIN =
  '어떤 수에 대한 asin(arcsine) 값을 돌려줍니다.';
Blockly.Msg.MATH_TRIG_TOOLTIP_ATAN =
  '어떤 수에 대한 atan(arctangent) 값을 돌려줍니다.';
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  '어떤 각도(degree, radian 아님) 의 cos(cosine) 값을 계산해 돌려줍니다.';
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  '어떤 각도(degree, radian 아님) 의 sin(sine) 값을 계산해 돌려줍니다.';
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  '어떤 각도(degree, radian 아님) 의 tan(tangent) 값을 계산해 돌려줍니다.';
Blockly.Msg.NEW_VARIABLE = '변수 만들기...';
Blockly.Msg.NEW_VARIABLE_TITLE = '변수 이름:';
Blockly.Msg.ORDINAL_NUMBER_SUFFIX = '';
Blockly.Msg.PROCEDURES_BEFORE_PARAMS = '전달:';
Blockly.Msg.PROCEDURES_CALLNORETURN_CALL = '';
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "미리 정의해 둔 '%1' 함수를 실행합니다.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "미리 정의해 둔 '%1' 함수를 실행하고, 함수를 실행한 결과 값을 돌려줍니다.";
Blockly.Msg.PROCEDURES_CREATE_DO = "'%1' 실행 블록 생성";
Blockly.Msg.PROCEDURES_DEFNORETURN_DO = '';
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = '함수 이름';
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = '다음';
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  '실행 후 결과 값을 돌려주지 않는 함수를 만듭니다.';
Blockly.Msg.PROCEDURES_DEFRETURN_DO = '';
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = '함수 이름';
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = '다음';
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = '다음을 돌려줌';
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  '실행 후 결과 값을 돌려주는 함수를 만듭니다.';
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  '경고: 이 함수에는, 같은 이름을 사용하는 매개 변수들이 있습니다.';
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = '함수 정의 찾기';
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  '첫 번째 값이 참(true) 이면 두 번째 값을 돌려줍니다.';
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  '경고: 이 블럭은 함수 정의 블럭 안에서만 사용할 수 있습니다.';
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = '전달:';
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = '전달변수이름';
Blockly.Msg.REMOVE_COMMENT = '설명 삭제';
Blockly.Msg.RENAME_ALL = 'Rename all %1';
Blockly.Msg.RENAME_PARAMETER = '매개 변수 이름 바꾸기...';
Blockly.Msg.RENAME_PARAMETER_TITLE = "모든 매개 변수 '%1'의 이름을 바꿉니다.";
Blockly.Msg.RENAME_THIS = 'Rename this %1';
Blockly.Msg.RENAME_VARIABLE = '변수 이름 변경...';
Blockly.Msg.RENAME_VARIABLE_TITLE = "모든 '%1' 변수 이름 변경 :";
Blockly.Msg.TEXT_APPEND_APPENDTEXT = '에 문장 덧붙임';
Blockly.Msg.TEXT_APPEND_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Text_modification';
Blockly.Msg.TEXT_APPEND_TO = '를 다음 값으로 변경';
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE = '모두 소문자로';
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = '첫 문자만 대문자로';
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = '모두 대문자로';
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  '특정 번째 위치에서 문자를 얻어내 돌려줍니다.';
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = '문장을 만들 조각 아이템';
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = '결합할 조각';
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  '이 문장 블럭의 구성을 추가, 삭제, 재구성 합니다.';
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH =
  '다음 문장에서 양쪽(왼쪽+오른쪽) 공백문자(space) 제거 :';
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT =
  '다음 문장에서 왼쪽 공백문자(space) 제거 :';
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT =
  '다음 문장에서 오른쪽 공백문자(space) 제거 :';
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  '문장의 왼쪽/오른쪽/양쪽에서 스페이스 문자를 제거해 돌려줍니다.';
Blockly.Msg.UNUSED_CODE = '사용하지 않는 코드';
Blockly.Msg.VARIABLE = 'variable';
Blockly.Msg.VARIABLES_DEFAULT_NAME = '문장조각';
Blockly.Msg.VARIABLES_GET_CREATE_SET = "'%1 값 변경' 블럭 생성";
...
Blockly.Msg.VARIABLES_SET_TAIL = '다음';
