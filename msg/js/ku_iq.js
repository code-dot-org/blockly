...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'دوو رەنگی وەک یەک پێکەوە لەگەڵ رێژەی (0.0 - 1.0) دەروخێت.';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'ڕەنگێك دروست بكە بە بڕێکى تایبەت لە سوور، سەوز و شین .هەموو بەهاکان دەبێت لەنێوان ٠ و ١٠٠ بێت.';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK =
  'پچڕان لە دەرەوەى گرێ /لوپ';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'بەردەوام بە لەگەڵ دووبارەبوونەوەی گرێی داهاتوو';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'لە گرێیەی تێدایت بڕۆ دەرەوە.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'وازبهێنە لەو بەشەی گرێ کە ماوە و گرێی داهاتوو دووبارە بکە.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'ئاگادارکردنەوە: لەوانەیە ئەم پارچەیە تەنیا لە نێوان گرێیەک بەکار بهێندرێت.';
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'با گۆڕاوی %1 لە نرخ لە ژمارەی یەکەم تا ژمارەی کۆتایی وەربگرێت،  بۆ ماوەی تایبەت زیاد بکەو فەرمانەکان بۆ پارچەی دیاریکراو جێبەجێ بکە.';
