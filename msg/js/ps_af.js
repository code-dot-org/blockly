...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'دوه رنګونه یو او بل ته د نږديوالی له کبله یوځاي کوي(۰.۰ ـ ۱.۰).';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'یو رنګ په معلومه اندازه د سور،  زرغون، او شین. څخه جوړ کړۍ چي اندازي د ۰ تر ۱۰۰ وسي.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = '';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'پاملرنه! تاسي په رښتیا غواړۍ ۱٪ ړنګ کړۍ؟';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'د تیري شوي حلقي پاتي برخه بیرته پیل کړۍ';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  'د نامناسبي حلقي څخه ووځۍ.';
