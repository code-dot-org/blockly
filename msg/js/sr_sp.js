...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'Помешати две боје у датом односу (0.0 - 1.0).';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'Направи боју са захтеваном количином црвене, зелене и плаве. Све вредности морају бити између 0 и 100.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = 'Креирај';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'Упозорење! Да ли сте сигурни да желите да избришете %1?';
Blockly.Msg.CONFIRM_RENAME_VARIABLE = '';
Blockly.Msg.CONTRACT_EDITOR_HEADER = 'Поступак за израду дизајна';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'настави са следећом итерацијом петље';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = 'Напусти петљу.';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  'Прескочи остатак ове петље, и настави са следећом итерацијом(понављањем).';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'Упозорење: Овај блок се може употребити само унутар петље.';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "За сваку ставку унутар листе, подеси промењиву '%1' по ставци, и онда начини неке изјаве-наредбе.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Нека промењива %1 узме вредности од почетног броја до задњег броја, бројећи по одређеном интервалу, и изврши одређене блокове.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'Додај услов у "ако" блок.';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Додај последњи услов за све преостале случајеве у "ако" петљи.';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Додај, уклони, или другачије поређај делове да би преуредио-ла овај if (ако) блок.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'ако је вредност тачна, онда изврши наредбе.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'ако је вредност тачна, онда изврши први блок наредби. У супротном, изврши други блок наредби.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'Ако је прва вредност тачна, онда изврши први блок наредби. У супротном, ако је друга вредност тачна , изврши други блок наредби.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'Ако је прва вредност тачна, онда изврши први блок наредби. У супротном, ако је друга вредност тачна, изврши други блок наредби. Ако ниједна од вредности није тачна, изврши последњи блок наредби.';
...
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = 'понављај';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'Све док вредност није тачна, извршавај наредбе.';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'Док је вредност тачна, извршавај наредбе.';
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'Дефиниши функцију испод и покушај поново.';
...
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "Ово ће обрисати сбе појаве '%1' параметра. Да ли си сигуран/на?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Дефинише пример са претпостављеним и стварним понашањем';
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL =
  'Које параметре треба да има ваша функција?';
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'Враћа листу, дужине 0, не садржи податаке';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'листа';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  'Додајте, избришите, или преуредите делове како бисте реорганизовали овај блок листе.';
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  'Креирај листу са било којим бројем ставки.';
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = 'узмите под-листу од првог';
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  'Враћа позицију првог/последњег појављивања ставке у листи. Враћа 0 ако се текст не нађе.';
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  'направити листу са ставком %1 која се понавља %2 пута';
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  'Прави листу која се састоји од задате вредности коју понављамо одређени број пута.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  'Убацује ставку на почетак листе.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END =
  'Убацује ставку на одређену позицију на листи. #1 је последња ставка.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START =
  'Убацује ставку на одређену позицију на листи.#1 је прва ставка.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  'Убацује ставку на насумично место на листи.';
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  'Убацује последњу ставку у листи.';
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  'Поставља (мења) ставку листе.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Враћа вредност тачно ако су оба уноса једнака.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Враћа вредност тачно ако је први унос већи од другог уноса.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  'Враћа вредност тачно ако је први унос већи или једнак другом уносу.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'Враћа за вредност тачно ако је први унос мањи од другог уноса.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'Враћа вредност тачно ако је први унос мањи или једнак другом уносу.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Враћа вредност тачно ако су оба уноса различита.';
Blockly.Msg.LOGIC_NEGATE_HELPURL = '';
Blockly.Msg.LOGIC_NEGATE_TITLE = 'није %1';
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  'Враћа за вредност тачно ако је унос нетачан. Враћа за вредност нетачно ако је унос тачан.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Враћа вредност тачно ако су оба уноса тачна.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Враћа вредност тачно ако је бар један од уноса тачан.';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Провери услов у 'test'. Ако је услов тачан, тада враћа 'if true' вредност; у другом случају враћа 'if false' вредност. ";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  'Враћа први број степенован на други број.';
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  'Врати неку од константи: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), или ∞ (бесконачно).';
Blockly.Msg.MATH_CONSTRAIN_HELPURL = '';
Blockly.Msg.MATH_CONSTRAIN_TITLE =
  'Ограничење за %1 - најмања вредност %2 највећа вредност %3';
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  'Ограничава број тако да буде у задатим границама (укључујући и границе).';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Проверава да ли је број паран, непаран, прост, цео, позитиван, негативан, или да ли је дељив одређеним бројем. Враћа true (тачно) или false (нетачно).';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  'Враћа просечну вредност (аритметичку средину) нумеричких вредности са листе.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  'Врати насумично одабрани елемент листе.';
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = 'Случајан број између 0 и 1';
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  'Враћа насумично одабран број између 0.0 (укључујући и 0.0) и 1.0 (без броја 1.0).';
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  'Враћа случајно одабрани цели број између две вредности, укључујући и те вредности.';
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Извршити функцију  '%1' коју је корисник дефинисао.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL = '';
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Извршити функцију  '%1' коју је корисник дефинисао и искористити резултат.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  'Прави функцију без враћања излазне вредности.';
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  'Прави функцију са враћањем излазне вредности.';
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  'Упозорење: ова функција има дупле параметре.';
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = 'Истакнути дефиницију функције';
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  'Ако је вредност тачна, врати другу вредност.';
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  'Упозорење: овај се блок може користити једино унутар дефиниције функције.';
...
Blockly.Msg.RENAME_VARIABLE_TITLE = "Преименуј све '%1' промењиве у:";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE =
  'измени тако да свака реч почиње великим словом';
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = 'великим словима';
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = 'Враћа копију текста у другом случају.';
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'Додај, уклони, или другачије поређај секције како би поново поставили овај текст блок.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  'узмите део текста почевши од првог слова';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  'узмите део текста од слова # од краја';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  'узмите део текста почевши од слова #';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  'Враћа позицију првог/задњег појављивања првог датог текста у другом датом тексту. Враћа 0 ако ништа није пронађено.';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  'Враћа копију текста са уклоњеним размацима са почетка и/или краја текста.';
Blockly.Msg.UNUSED_CODE = 'Неискоришћен код';
Blockly.Msg.VARIABLE = 'variable';
Blockly.Msg.VARIABLES_DEFAULT_NAME = 'ставка';
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Направи 'упиши %1'";
Blockly.Msg.VARIABLES_GET_HELPURL = '';
Blockly.Msg.VARIABLES_GET_TAIL = '';
Blockly.Msg.VARIABLES_GET_TITLE = '';
Blockly.Msg.VARIABLES_GET_TOOLTIP = 'Враћа вредност ове променљиве.';
Blockly.Msg.VARIABLES_SET_CREATE_GET = "Креирај 'прочитај %1'";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  'Подеси ову променљиву да буде једнака уносу.';
