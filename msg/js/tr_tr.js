...
Blockly.Msg.ADD_PARAMETER = 'Parametre ekle';
Blockly.Msg.CANCEL = 'İptal';
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  'İki rengi verilen bir oranda(0.0 - 1.0) karıştırır.';
...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = 'Rastgele bir renk seçer.';
...
Blockly.Msg.COLOUR_RGB_TITLE = 'renklendir';
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  'Belirtilen miktarlarda kırmızı, yeşil ve mavi ile bir renk oluşturur. Tüm değerler 0 ile 100 arasında olmalıdır.';
Blockly.Msg.CONFIRM_CREATE_VARIABLE = 'Oluştur';
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE =
  'Uyarı! %1 öğesini silmek istediğinizden emin misiniz?';
Blockly.Msg.CONFIRM_RENAME_VARIABLE = 'Yeniden adlandır';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  'Döngünün sonraki adımından devam et';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  'Uyarı: Bu blok sadece bir döngü içinde kullanılabilir.';
Blockly.Msg.CONTROLS_FOREACH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Loops#for_each';
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = 'için';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Listedeki her öğeyi  '%1' değişkenine ver ve komutu yerine getir.";
...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY =
  '%1 den %2 ye, her adımda %3 değişim';
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = 'şununla say';
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  '%1 değişkenini başlangıç numarasından bitiş numarasına kadar belirtilen farkla değerler verirken belirtilen blokları gerçekleştirir.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'If (eğer) bloğuna bir koşul ekleyin.';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'If (eğer) bloğuna kalan durumları "yakalayan" bir son ekle.';
Blockly.Msg.CONTROLS_IF_HELPURL =
  'http://code.google.com/p/blockly/wiki/If_Then';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'If (eğer) bloğunu düzenlemek için bölümleri ekle, kaldır veya yeniden sırala.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  'Eğer değer doğruysa ardından gelen işlemleri yapar.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'Eğer değer doğru ise ilk bloktaki işlemleri yapar. Aksi halde ikinci bloktaki işlemleri yapar.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'Eğer ilk değer doğru ise ilk blok içerisindeki işlem(ler)i yapar. İlk değer doğru değil ve ikinci değer doğru ise, ikinci bloktaki işlem(ler)i yapar.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'Eğer ilk değer doğru ise ilk bloktaki işlem(ler)i gerçekleştirir. İlk değer doğru değil ve ikinci değer doğru ise, ikinci bloktaki işlem(ler)i gerçekleştirir. Eğer değerlerin hiçbiri doğru değil ise son bloktaki işlem(ler)i gerçekleştirir.';
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  'http://en.wikipedia.org/wiki/For_loop  Döngü';
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = 'yap';
Blockly.Msg.CONTROLS_REPEAT_TITLE = '%1 kez tekrarla';
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = 'bu işlemleri';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = 'şu doğruyken tekrarla:';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  'Bir değer yanlış olduğu sürece işlemleri yapar.';
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  'Bir değer doğru olduğu sürece işlemleri yapar.';
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE =
  'Aşağıdaki işlevi tanımlayın ve yeniden deneyin.';
Blockly.Msg.DELETE = 'Sil';
Blockly.Msg.DELETE_BLOCK = "Blok'u Sil";
Blockly.Msg.DELETE_PARAMETER = 'Değer sil...';
Blockly.Msg.DELETE_PARAMETER_TITLE =
  "Bu komut, tüm '%1' değeleri siler. Emin misiniz?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION =
  'Beklenen ve fiili davranışları ile örnek tanımlar';
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL =
  'Fonksiyonun hangi parametreleri alıyor?';
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP =
  'Fonksiyonel yöntemi tanımlayın';
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  'Veri kaydı içermeyen, uzunluğu 0 olan bir liste verir';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'liste';
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  'Bu liste bloğunu yeniden yapılandırmak için bölüm ekle, kaldır veya yeniden sırala.';
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  'Öğenin listede ilk/son görüldüğü konumu döndürür. Öğe bulunamazsa 0 döndürür.';
Blockly.Msg.LISTS_INLIST = 'için';
Blockly.Msg.LISTS_IS_EMPTY_HELPURL =
  'https://code.google.com/p/blockly/wiki/Lists#is_empty Boş Listeler';
Blockly.Msg.LISTS_IS_EMPTY_TITLE = '%1 boş';
Blockly.Msg.LISTS_LENGTH_HELPURL =
  'https://code.google.com/p/blockly/wiki/Lists#length_of  Uzunluk Listeleri';
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  '%1 nesnenin %2 kez tekrarlandığı bir liste yarat';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Girilen iki değer birbirine eşitse doğru değeri verir.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Girilen ilk değer ikinci değerden daha büyükse doğru değeri verir.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  'Girilen ilk değer ikinci değerden büyük veya eşitse doğru değeri verir.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'Girilen ilk değer ikinci değerden küçükse doğru değeri verir.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'Girilen ilk değer ikinci değerden küçük veya eşitse doğru değeri verir.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Girilen iki değerde birbirine eşit değilse doğru değeri verir.';
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  'Girilen değer yanlışsa doğru değerini verir. Girilen değer doğruysa yanlış değerini verir.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Girilen iki değerde doğruysa doğru değeri verir.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Girilen iki değerden en az biri doğruysa doğru değeri verir.';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  " 'dene'deki şartı dener. Eğer şart doğru ise 'doğru ise'deki değeri verir, aksi halde 'yanlış ise'deki değeri verir.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  'İlk sayının ikincinin kuvvetine yükseltilmişini verir.';
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  'Yaygın sabitlerden birini verir: π (3.141…), e (2.718…), φ (1.618…), karekök(2) (1.414…), karekök(½) (0.707…), veya ∞ (sonsuz).';
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  'Bir sayıyı belirli iki sayı arasında sınırlandır.(sınır noktalar dahil).';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Bir sayının çift mi, tek mi , tam mı, asal mı, pozitif mi, negatif mi, veya tam bir sayıyla bölünebilirliğini kontrol eder. Doğru veya yanlış değeri verir.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  'Listedeki sayısal değerlerin ortalamasını (aritmetik ortalama) döndür.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  'Listedeki en sık tekrarlanan öge veya ögelerin listesini döndür.';
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  'Listedeki tüm sayıların toplamını döndür.';
Blockly.Msg.MATH_POWER_SYMBOL = 'üs alma';
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  'http://en.wikipedia.org/wiki/Random_number_generation  Rast gele sayı üretme';
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = 'rastgele kesir';
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  '0.0 (dahil) ve 1.0 (hariç) sayıları arasından rastgele bir kesir döndür.';
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  'Belirlenen iki sayı arasında, bu sayılar da dahil olmak üzere, rastgele bir tam sayı döndür.';
Blockly.Msg.MATH_ROUND_HELPURL =
  'http://en.wikipedia.org/wiki/Rounding  Yuvarlama';
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  'http://en.wikipedia.org/wiki/Square_root  Kare kök';
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP =
  "Bir sayının e ' inci  kuvvetini döndür .";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = 'Bir sayının doğal logaritmasını döndür .';
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  'Bir sayının 10 tabanındaki logaritmasına döndür.';
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = 'Sayıyı negatif haline döndür.';
...
Blockly.Msg.MATH_TRIG_HELPURL =
  'http://en.wikipedia.org/wiki/Trigonometric_functions  Trigonometrik fonksiyonlar ';
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  'Bir açının kosinüsünü verir(radyan olarak değil).';
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  'Bir açının sinüsünü verir(radyan olarak değil).';
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  'Bir açının tanjantını verir(radyan olarak değil).';
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Kullanıcı tanımlı '%1' fonksiyonunu çalıştır.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Kullanıcı tanımlı '%1' fonksiyonunu çalıştır ve sonucunu kullan.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = 'Şunu yapmak için:';
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  'Sonuç vermeyen bir fonksiyon oluşturur.';
...
Blockly.Msg.RENAME_PARAMETER_TITLE =
  "Tüm '%1' parametrelerini şu şekilde adlandır:";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  "Tüm '%1' değişkenlerini şu şekilde adlandır:";
Blockly.Msg.TEXT_APPEND_APPENDTEXT = 'metin ekle';
Blockly.Msg.TEXT_APPEND_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Text_modification   Yazı değişimi';
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP = 'Belirli pozisyonda harfi döndürür.';
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'Bu metin bloğunu düzenlemek için bölüm ekle, sil veya yeniden görevlendir.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  'ilk harften başlayarak metnin alt dizesini al';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  '# inci harften sona kadar metnin parçasını al';
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  '#. harften başlayarak metnin alt dizesini al';
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = 'metnin son bulunduğu yeri bul';
Blockly.Msg.TEXT_INDEXOF_TAIL = '';
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  'İlk metnin, ikinci metnin içindeki ilk/son görülüşlerinin indeksini verir. Metin bulunamadıysa 0 verir.';
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  'Verilen metin boşsa true(doğru) değerini verir.';
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  'Herhangi bir sayıda ki öğeleri bir araya getirerek metnin bir parçasını oluştur.';
...
Blockly.Msg.TEXT_PRINT_HELPURL =
  'https://code.google.com/p/blockly/wiki/Text#Printing_text  Yazıyı yazdırmak ';
Blockly.Msg.TEXT_PRINT_TITLE = "%1 ' i Yaz";
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  'Belirli bir metni,sayıyı veya başka bir değeri yaz.';
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER =
  'İstek mesajı göstererek kullanıcıdan sayı al.';
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = 'Her iki taraftaki boşlukları kırp';
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = 'Soldaki boşlukları  kırp';
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = 'Sağdaki boşlukları kırp';
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  'Metnin bir veya her iki ucundan da boşlukları silinmiş şekilde kopyasını verir.';
Blockly.Msg.UNUSED_CODE = 'Kullanılmayan kod';
Blockly.Msg.VARIABLE = 'variable';
Blockly.Msg.VARIABLES_DEFAULT_NAME = 'öge';
Blockly.Msg.VARIABLES_GET_CREATE_SET = "'%1'e ayarla' oluştur";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = "' %1 al' oluştur";
