...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  '以指定的红、绿、蓝色值来创建一个颜色。所有颜色的值必须介于0到100之间。';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  '如果这个变量为真，执行第一部分语句。否则，执行第二部分语句。';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  '如果第一个值为真，执行第一部分的语句。否则，如果第二个值为真，执行第二部分的语句。';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  '如果第一个变量为真，执行第一部分的语句。否则，如果第二个变量为真，执行第二部分的语句。如果没有一个变量为真，执行最后一部分的语句。';
...
Blockly.Msg.FUNCTION_NAME_LABEL = '命名你的函数：';
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = '你的函数要用来做什么呢？';
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = '你的函数需要哪些参数？';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "检查test中的条件。如果条件为真，将返回 '如果为真'的值；否则，返回的 '如果为假'的值。";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  '返回的常见常量之一： π (3.141......)，e (2.718...)、 φ (1.618...)、 sqrt(2) (1.414......)、 sqrt(½) (0.707......) 或 ∞ （无穷大）。';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  '判断一个数是否为偶数，奇数，质数，正数，负数，或者可以被某数整除，返回真或假。';
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  'http://zh.wikipedia.org/wiki/子程序';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  '返回第二个文本中的第一个文本的第一个/最后一个匹配项的索引。如果未找到该文本，则返回 0。';
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  '返回文本的一份拷贝，其中从一端或两端同时删除了空格。';
Blockly.Msg.UNUSED_CODE = '未使用的代码';
