...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  '將紅、綠、藍三原色的色光以指定的比例相加，產生色光。所有數值必須在 0 和 100 之間。';
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  '當程式執行到這裡時，不管如何都會強制跳離所在的迴圈，而到達迴圈以後的第一行陳述。';
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  '當程式執行到這裡時，會強制中斷並直接跳回迴圈的開頭，繼續迴圈的下一個循環。';
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "遍歷每個列表中的項目，將變量  '%1' 設定到該項目中，然後執行某些語句";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  '如果值為 true，就執行第一個陳述指令；否則，執行第二個陳述的指令。';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  '如果第一個值為 true，就執行第一個陳述的指令；不然，如果第二個值是 true，就執行第二個陳述的指令。';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  '如果第一個值為 true，執行第一個陳述指令；不然，第二個值是 true 時執行第二個陳述指令；如果所有的值都不是 true，就執行最後一個陳述指令。';
...
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = '循環';
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  '返回在列表中的第一個/最後一個匹配項目的索引值。如果未找到則返回 0。';
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  '如果輸入的是 false，就回傳 true；如果輸入的是 true，就回傳 false。';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  '如果二個輸入的內容為 true，就回傳 ture。';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  '如果二個輸入的內容，有一個為 true，就回傳 ture。';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  '測試條件，如果條件符合（true），就回傳「若為 true」裡的值；否則就回傳「若為 false」裡的值。';
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  '回傳「A 的 B 次方」的結果（A 是第一個數，B 是第二個數）。';
...
Blockly.Msg.MATH_IS_TOOLTIP =
  '檢查數字是不是偶數，奇數，正整數，正數、 負數、被整除的數，若是回傳 true，若不是回傳 false。';
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  '回傳一個大於等於 0.0，但小於 1.0 的隨機數字。';
Blockly.Msg.MATH_RANDOM_INT_HELPURL = '';
Blockly.Msg.MATH_RANDOM_INT_TITLE = '隨機整數（%1 到 %2）';
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  '回傳介於指定數字之間的隨機整數（可以等於指定數）。';
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = '組合';
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  '利用添加、移除、排序以重新配置這個文字積木。';
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  '傳回在第二個字串中，第一個或最後一個符合項目的索引值。如果沒找到則傳回 0。';
...
Blockly.Msg.VARIABLES_SET_TAIL = '為';
Blockly.Msg.VARIABLES_SET_TITLE = '設定';
